...
/**
 * get_func - this selects the correct  function
 * @parsed: this is the bytecode line
 *
 * Return: points selected function, or NULL on failure
 */
...
/**
 * push_handler - this function handles push command
 * @stack: double pointer to the stavk being pushed
...
/**
 * pall_handler - this function handles  pall command
 * @stack: double pointer to the stack being pushed
